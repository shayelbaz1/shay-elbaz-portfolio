...
import { ANIMATION_VARIANTS } from "../constants/theme";
import { ContactInfo, SocialLink } from "./Shared";

const headlineWords = DATA.title.split(" ");
        ...
        <div className="flex-1">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <motion.p variants={ANIMATION_VARIANTS.hero.item} className="text-xl lg:text-3xl font-bold text-white/60 tracking-tight uppercase mb-8 max-w-2xl">
